...
Install the _react-mentions-extended_ package via npm:

```
npm install react-mentions-extended --save
```

Or yarn:

```
yarn add react-mentions-extended
```

The package exports two React components for rendering the mentions textarea:

```javascript
import { MentionsInput, Mention } from 'react-mentions-extended'
```
