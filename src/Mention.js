...
const Mention = ({
  ...
  console.log('ALOO ~ styles:', styles)

  console.log('ALOO ~ Mention ~ mismatchColor:', mismatchColor)
  ...
  if (data instanceof Array) {
    const isNotMismatched = data.find(
      (d) =>
        display in d && d.display === display.replace('[', '').replace(']', '')
    )
